...
Все навыки из библиотеки Superpowers и в выводе отображаются с префиксом `superpowers:`.

## Архитектура

- **Docker-образ** — содержит репозиторий Superpowers в виде git-подмодуля
